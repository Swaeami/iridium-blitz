...
2. **Clone your fork** locally
   ```
   git clone https://github.com/Swaeami/iridium-blitz.git
   cd Blitz
   ```
...
1. Check the [Issues](https://github.com/Swaeami/iridium-blitz/issues) page to see if it has already been reported
